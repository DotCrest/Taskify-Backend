...
namespace Application.ServiceAbstractions
{
    public interface IWorkSpaceService
    {
        ...
        Task<Result<bool>> UpdateWorkSpaceAsync(int workspaceId, UpdateWorkspaceDto updateWorkspaceDto, string userId);
        Task<Result<bool>> DeleteWorkSpaceAsync(int workspaceId, string userId);
