...
public interface IQuestService
{
    ...
    Task<Result<PagedResponse<QuestToReturnDto>>> GetAllQuests(string userId, int spaceId, QuestCustomQueryFilter queryFilter);
    ...
    Task<bool> IsQuestExisted(int questId, int spaceId);
    Task<bool> IsQuestExisted(int questId);
}
